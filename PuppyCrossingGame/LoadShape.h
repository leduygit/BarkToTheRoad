...
enum ShapeIndex
{
	...
	RANK_BUTTON, RANK_BUTTON_HOVER, SETTING_BUTTON, SETTING_BUTTON_HOVER, 
	...
	CLOSE_DIALOG, GHOST, BACKGROUND_EMPTY, GAME_OVER, TROPHY_SMALL, TROPHY_SMALL_HOVER,
	TEXTBOX, LEADERBOARD, AMBULANCE, SETTING_WINDOW, SPEAKER, SPEAKER_HOVER, MUTE, MUTE_HOVER,
	CREDIT_BUTTON, CREDIT_BUTTON_HOVER, CREDIT_WINDOW, INSTRUCTION_WINDOW_1, INSTRUCTION_WINDOW_2,
	PRE_BUTTON, PRE_BUTTON_HOVER, NEXT_BUTTON, NEXT_BUTTON_HOVER, 
};
